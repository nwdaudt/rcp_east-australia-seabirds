...
**Data availability statement:** The gridded data used as the basis for all analyses is available in the archived repository along with the code to reproduce the results. The raw data are currently being used for other projects and thus can not be publicly available. If you are interested in the raw data, please get in touch with EJW.

**Funding statement:** .........**Eric - any specific funding(s) we need to acknowledge?**
