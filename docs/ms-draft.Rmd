...
```{r fig5-spp-profiles, fig.cap = "**FIGURE 5.** Species profiles of seabird assembalges off eastern Australia given by spring presence-absence (a) and abundance (b) Region of Common Profile models. Note that values in (b) are log10 transformed. Results for other seasons and models can be found in the Supplementary Material.", fig.align = "center", echo = FALSE}
